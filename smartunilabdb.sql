...
INSERT INTO `lab` VALUES (1,'Physics','Ground',30,NULL,2500),(15,'Digital Logic Design Lab','Ground',30,NULL,2500),(134,'Computer Lab','First',30,NULL,2500),(135,'Computer Lab','First',30,NULL,2500),(243,'Robotics Lab','Second',30,NULL,2500),(244,'Physics Lab','Second',30,NULL,2500),(245,'Virtually Reality','Second',30,NULL,2500),(246,'Digital Logic Design Lab','Second',30,NULL,2500),(247,'Computer Lab','Second',30,NULL,2500),(250,'Computer Lab','Second',30,NULL,2500),(251,'CyberSecurity Lab','Second',30,NULL,2500),(255,'Research Lab','second',10,NULL,2500),(256,'Research lab','Second',10,NULL,2500);
...
CREATE TABLE `research` (
  ...
  CONSTRAINT `research_ibfk_2` FOREIGN KEY (`StudentID`) REFERENCES `student` (`StudentID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
