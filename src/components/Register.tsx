...
export function Register({ onRegister, onBackToLogin }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const user: User = {
        id: (response.studentId || response.instructorId || response.technicianId || 0).toString(),
        name: response.name,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7FA] via-[#CBD5E0] to-[#8BB4D9] dark:from-[#1A1D23] dark:via-[#252932] dark:to-[#1A1D23] flex items-center justify-center p-4 animate-fadeIn">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-[#252932] rounded-lg shadow-2xl p-8 animate-slideInLeft border-2 border-[#CBD5E0] dark:border-[#3A4150]">
          <h2 className="mb-6 text-center text-[#5B9BD5] dark:text-[#8BB4D9]">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Student ID */}
            <div>
              <label htmlFor="studentId" className="block text-gray-700 dark:text-[#B0B0B0] mb-2">
                Student ID *
              </label>
              <input
                id="studentId"
                ...
                required
                min="1000000"
                className="w-full px-4 py-3 border-2 border-[#CBD5E0] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B9BD5] dark:focus:ring-[#8BB4D9] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match your registered Student ID</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-[#CBD5E0] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B9BD5] dark:focus:ring-[#8BB4D9] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match the name registered with your Student ID</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-[#CBD5E0] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5B9BD5] dark:focus:ring-[#8BB4D9] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match the email registered with your Student ID</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="flex items-center justify-center gap-2 text-sm text-[#5B9BD5] dark:text-[#8BB4D9] hover:underline"
            >
