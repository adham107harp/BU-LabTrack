...
export function RegisterTechnician({ onRegister, onBackToLogin }: RegisterTechnicianProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.registerTechnician({
      ...
      const user: User = {
        id: (response.technicianId || 0).toString(),
        name: response.name,
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FAF9F5] via-[#EADFB4] to-[#9BB0C1] dark:from-[#1A1D23] dark:via-[#252932] dark:to-[#1A1D23] flex items-center justify-center p-4 animate-fadeIn">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-scaleIn">
          ...
          <p className="text-gray-600 dark:text-[#B0B0B0]">Technician Registration</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#252932] rounded-lg shadow-2xl p-8 animate-slideInLeft border-2 border-[#EADFB4] dark:border-[#3A4150]">
          <h2 className="mb-6 text-center text-[#51829B] dark:text-[#9BB0C1]">Create Technician Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Technician ID */}
            <div>
              <label htmlFor="technicianId" className="block text-gray-700 dark:text-[#B0B0B0] mb-2">
                Technician ID *
              </label>
              <input
                id="technicianId"
              ...
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match your registered Technician ID</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-[#EADFB4] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#51829B] dark:focus:ring-[#9BB0C1] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match the name registered with your Technician ID</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-[#EADFB4] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#51829B] dark:focus:ring-[#9BB0C1] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must be @badyauni.edu.eg</p>
            </div>

            {/* Specialization */}
            <div>
              <label htmlFor="specialization" className="block text-gray-700 dark:text-[#B0B0B0] mb-2">
                Specialization *
              </label>
              <input
                id="specialization"
                ...
                placeholder="e.g., Physics Lab, Computer Lab"
                required
                className="w-full px-4 py-3 border-2 border-[#EADFB4] dark:border-[#3A4150] bg-white dark:bg-[#2F3541] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#51829B] dark:focus:ring-[#9BB0C1] focus:border-transparent transition-all"
              />
              <p className="text-xs text-gray-500 dark:text-[#6B6B6B] mt-1">Must match your registered specialization</p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-[#F6995C] to-[#51829B] text-white rounded-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="flex items-center justify-center gap-2 text-sm text-[#51829B] dark:text-[#9BB0C1] hover:underline"
            >
